...
campos_t camPos[NOMBRECAM] = {
    { -23, -6, 0.342, 0.939 },    // 0
    { -6, -23, 0.939, 0.342 },    // 1
    { 2006, -23, -0.939, 0.342 }, // 2
    { 2023, -6, -0.342, 0.939 },  // 3
    { 1034, 3012, 0.906, -0.422 },// 4
    { 1014, 3005, 0.5, -0.866 },  // 5
    { 986, 3005, -0.5, -0.866 },  // 6
    { 966, 3012, -0.906, -0.422 },// 7
};
...
//if all the vector have the same number of the position no new calculation is made   
    ...
    while(!quitServer) {
        ...
        //  grand robot ennemi
        msntorobot[0] = 1;
        msntorobot[1] = posRobot[4].x;
        msntorobot[2] = posRobot[4].y;
        //msntorobot[3]=0;
        
        // petit robot ennemi
        msntorobot[4] = 2;
        msntorobot[5] = posRobot[5].x;
        msntorobot[6] = posRobot[5].y;
        //msntorobot[7]=0;
        
        // grand robot allié
        msntorobot[8] = 3;
        msntorobot[9] = (posRobot[0].x + posRobot[1].x);
        msntorobot[10] = (posRobot[0].y + posRobot[1].y);
        
        // petit robot allié
        msntorobot[12] = 4;
        msntorobot[13] = (posRobot[2].x + posRobot[3].x);
        msntorobot[14] = (posRobot[2].y + posRobot[3].y);
